...
class _SplashScreenState extends State<SplashScreen>
  ...
  Animation<double>? opacity; // Nullable type
  AnimationController? controller; // Nullable type
  User? user; // Nullable type
  ...
  @override
  void dispose() {
    controller?.dispose(); // Null-aware dispose
    super.dispose();
  }
          ...
          child: new Scaffold(
            body: Column(
              children: <Widget>[
                Expanded(
                  child: Opacity(
                      opacity: opacity?.value ?? 1.0, // Null-aware access
