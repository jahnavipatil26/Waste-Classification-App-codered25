...
import 'pages/map_page.dart'; // Import the new MapPage
...
class _WasteClassifierState extends State<WasteClassifier> {
  ...
  Future<void> _classifyImage(XFile image) async {
    ...
    setState(() {
      ...
      _result = "Predicted Waste Class: ${outputClass[predictedClass]}";
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            // Add "Suggest Nearby Smartbins" button
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
              ...
              child: Text('Suggest Nearby Smartbins'),
            ),
          ],
        ),
      ),
