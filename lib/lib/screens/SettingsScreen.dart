...
class SettingsScreen extends StatefulWidget {
  ...
  // Marking the user parameter as required and key as nullable
...
class _SettingsState extends State<SettingsScreen> {
  // Removed 'titsle' as it was unused and misspelled
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ProfileMenu(
              ...
              press: () async {
                ...
                await canLaunch(facebookUrl)
                    ? launch(facebookUrl)
                    : print("open facebook app link or show a snackbar with notification that there is no facebook installed");
              },
            ),
            // ProfileMenu(
            //   text: "Leaderboard",
            ...
            //     await canLaunch(leaderboardUrl)
            //         ? launch(leaderboardUrl)
            //         : print("open moms store nepal leaderboard link");
            //   },
            // ),
            ProfileMenu(
              text: "Delete Account",
